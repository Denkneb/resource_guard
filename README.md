...
```console
sha256sum --check resource-guard-0.2.0-x86_64-unknown-linux-gnu.tar.gz.sha256
tar -xzf resource-guard-0.2.0-x86_64-unknown-linux-gnu.tar.gz
cd resource-guard-0.2.0-x86_64-unknown-linux-gnu
```
